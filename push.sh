...
#docker push imarcagency/ops-apache-php74:$OPS_VERSION
#docker push imarcagency/ops-apache-php80:$OPS_VERSION
docker push imarcagency/ops-apache-php81:$OPS_VERSION
